...
export interface paths {
    "/mcp-status": {
        ...
        /** Mcp Status */
        get: operations["mcp_status_mcp_status_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/favicon.ico": {
        ...
        /**
         * Serve Root Favicon
         * @description Serve app favicon at site root (avoids Gradio default + broken /ui/*\/relative icon URLs).
         */
        get: operations["serve_root_favicon_favicon_ico_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/favicon.png": {
         ...
         * @description Serve app favicon at site root (avoids Gradio default + broken /ui/*\/relative icon URLs).
         */
        get: operations["serve_root_favicon_favicon_png_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/raw-preview": {
        ...
        /**
         * Get RAW embedded preview
         * @description Returns an embedded RAW preview as binary JPEG bytes.
         */
        get: operations["raw_preview_endpoint_api_raw_preview_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/runs/validation-repair/preview": {
        ...
        get?: never;
        put?: never;
        /** Preview stale/missing work for scope (alias) */
    ...
    "/api/runs/plan/preview": {
        ...
        get?: never;
        put?: never;
        /** Preview stale/missing work for scope */
        post: operations["preview_validation_repair_api_runs_plan_preview_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/runs/folder-buckets": {
        ...
        /** Paginated folder buckets for Runs auto-queue */
        get: operations["get_run_folder_buckets_api_runs_folder_buckets_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/runs/auto-drive": {
        ...
        get?: never;
        put?: never;
        /** Auto-queue folder runs from bucket planner */
        post: operations["auto_drive_runs_api_runs_auto_drive_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/runs/drive/start": {
        ...
        get?: never;
        put?: never;
        /** Start the durable auto-drive loop */
        post: operations["start_runs_drive_api_runs_drive_start_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/runs/drive/stop": {
        ...
        get?: never;
        put?: never;
        /** Stop the durable auto-drive loop */
        post: operations["stop_runs_drive_api_runs_drive_stop_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/runs/drive/status": {
        ...
        /** Auto-drive loop status + outstanding work */
        get: operations["runs_drive_status_api_runs_drive_status_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/db/ping": {
        ...
        /**
         * Ping
         * @description Connectivity probe. Returns the active DB engine name.
         */
    ...
    "/api/db/query": {
         ...
         *     are blocked.
         */
        post: operations["raw_query_api_db_query_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/transaction": {
        ...
        /**
         * Raw Transaction
         * @description Execute a batch of write statements atomically.
         *
         *     Body fields:
         ...
         */
        post: operations["raw_transaction_api_db_transaction_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/images/by-path": {
        ...
        /** Get Image Details */
        get: operations["get_image_details_api_db_images_by_path_get"];
        put?: never;
        post?: never;
        /** Delete Image */
        delete: operations["delete_image_api_db_images_by_path_delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    };
    "/api/db/images/by-hash/{image_hash}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get Image By Hash */
        get: operations["get_image_by_hash_api_db_images_by_hash__image_hash__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/db/images/upsert": {
        ...
        put?: never;
        /** Upsert Image */
        post: operations["upsert_image_api_db_images_upsert_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/images": {
        ...
        /** Get Images */
        get: operations["get_images_api_db_images_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/db/images/incomplete": {
        ...
        get: operations["get_incomplete_records_api_db_images_incomplete_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/db/images/{image_id}": {
        ...
        head?: never;
        /** Update Image Fields */
        patch: operations["update_image_fields_api_db_images__image_id__patch"];
        trace?: never;
    };
    "/api/db/images/batch-update": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Update Image Fields Batch */
        post: operations["update_image_fields_batch_api_db_images_batch_update_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/images/batch-embeddings": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Update Embeddings Batch */
        post: operations["update_embeddings_batch_api_db_images_batch_embeddings_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/images/{image_id}/paths": {
        ...
        /** Get All Paths */
        get: operations["get_all_paths_api_db_images__image_id__paths_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/db/images/{image_id}/resolved-path": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get Resolved Path */
        get: operations["get_resolved_path_api_db_images__image_id__resolved_path_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/db/images/{image_id}/phases": {
        ...
        /** Get Image Phases */
        get: operations["get_image_phases_api_db_images__image_id__phases_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/db/jobs": {
        ...
        /** Get Jobs */
        get: operations["get_jobs_api_db_jobs_get"];
        put?: never;
        /** Create Job */
        post: operations["create_job_api_db_jobs_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/jobs/{job_id}": {
        ...
        /** Get Job */
        get: operations["get_job_api_db_jobs__job_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
        /** Update Job Status */
        patch: operations["update_job_status_api_db_jobs__job_id__patch"];
        trace?: never;
    };
    "/api/db/jobs/dequeue": {
        parameters: {
        ...
        put?: never;
        /** Dequeue Job */
        post: operations["dequeue_job_api_db_jobs_dequeue_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/jobs/enqueue": {
        ...
        put?: never;
        /** Enqueue Job */
        post: operations["enqueue_job_api_db_jobs_enqueue_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/jobs/recover": {
        ...
        post: operations["recover_interrupted_jobs_api_db_jobs_recover_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/jobs/{job_id}/phases": {
        ...
        /** Get Job Phases */
        get: operations["get_job_phases_api_db_jobs__job_id__phases_get"];
        put?: never;
        /** Create Job Phase */
        post: operations["create_job_phase_api_db_jobs__job_id__phases_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/jobs/{job_id}/phases/{phase_code}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        /** Update Job Phase */
        put: operations["update_job_phase_api_db_jobs__job_id__phases__phase_code__put"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/db/folders": {
        ...
        /** Get Folders */
        get: operations["get_folders_api_db_folders_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/db/folders/scored": {
        ...
        /** Is Folder Scored */
        get: operations["is_folder_scored_api_db_folders_scored_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/db/folders/get-or-create": {
        ...
        post: operations["get_or_create_folder_api_db_folders_get_or_create_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/folders/sync": {
        ...
        put?: never;
        /** Sync Folders */
        post: operations["sync_folders_api_db_folders_sync_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/folders/phase-summary": {
        ...
        /** Get Folder Phase Summary */
        get: operations["get_folder_phase_summary_api_db_folders_phase_summary_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/db/folders/phase-status": {
        ...
        get?: never;
        /** Update Folder Phase Status */
        put: operations["update_folder_phase_status_api_db_folders_phase_status_put"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/db/stacks/count": {
        ...
        /** Get Stacks Count */
        get: operations["get_stacks_count_api_db_stacks_count_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/db/stacks/by-image-ids": {
        ...
        get?: never;
        put?: never;
        /** Get Stacks By Image Ids */
        post: operations["get_stacks_by_image_ids_api_db_stacks_by_image_ids_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/stacks/batch-create": {
        ...
        put?: never;
        /** Create Stacks Batch */
        post: operations["create_stacks_batch_api_db_stacks_batch_create_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/stacks/clear": {
        ...
        put?: never;
        /** Clear Stacks */
        post: operations["clear_stacks_api_db_stacks_clear_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/culling/sessions": {
        ...
        get?: never;
        put?: never;
        /** Create Culling Session */
        post: operations["create_culling_session_api_db_culling_sessions_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/culling/sessions/{session_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get Culling Session */
        get: operations["get_culling_session_api_db_culling_sessions__session_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/db/utils/generate-uuid": {
        ...
        put?: never;
        /** Generate Uuid */
        post: operations["generate_uuid_api_db_utils_generate_uuid_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/db/backup": {
        ...
        put?: never;
        /** Backup Database */
        post: operations["backup_database_api_db_backup_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/status/data": {
         ...
         * @description Live status data consumed by the /app operator page (threads, profiling, runners, log).
         */
        get: operations["status_data_endpoint_api_status_data_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/status/logs": {
         ...
         * @description Log sections only (webui.log + debug.log HTML) for the React SPA /ui/logs page.
         */
        get: operations["status_logs_endpoint_api_status_logs_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/status/log-tails": {
        ...
        /**
         * Status Log Tails Endpoint
         * @description JSON tails for webui.log and/or debug.log (same paths as /api/status/logs).
         */
        get: operations["status_log_tails_endpoint_api_status_log_tails_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/manifest.json": {
        ...
        /**
         * Manifest Endpoint
         * @description Serve a minimal web app manifest to prevent 404 errors.
         */
        get: operations["manifest_endpoint_manifest_json_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/ui/{full_path}": {
        ...
        /**
         * Serve Spa
         * @description Serve React SPA for all /ui/* paths (client-side routing).
         */
        get: operations["serve_spa_ui__full_path__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /** Body_clear_stacks_api_db_stacks_clear_post */
        Body_clear_stacks_api_db_stacks_clear_post: {
            /** Folder Id */
            folder_id: number;
        };
        ...
        ConfigResponse: {
            ...
            /**
             * Scoring Models
             * @description scoring.models membership map: {model_name: {enabled, shadow}}. Lets the UI show known models (and which are active vs. disabled).
             */
            scoring_models?: {
                [key: string]: {
                    [key: string]: boolean;
        ...
        PipelineSubmitRequest: {
             ...
             * @example false
             */
            generate_accessibility: boolean;
            /**
        ...
        RunSubmitRequest: {
            ...
            /**
             * Run Mode
             * @default process_stale_or_missing
             * @constant
             */
        ...
        RunsAutoDriveRequest: {
            ...
            /**
             * Limit
             * @description Maximum folder runs to queue in this drive tick.
             * @default 50
             */
            limit: number;
            /**
             * Dry Run
             * @description When true, return the proposed queue operations without writing jobs.
             * @default false
             */
            dry_run: boolean;
            /**
        ...
        RunsDriveStartRequest: {
            ...
            /**
             * Limit
             * @description Max folder runs queued per drive tick.
             * @default 50
             */
            limit: number;
            /**
...
export interface operations {
    ...
    serve_root_favicon_favicon_ico_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    serve_root_favicon_favicon_png_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    raw_preview_endpoint_api_raw_preview_get: {
        parameters: {
            query: {
                path: string;
            };
        ...
        responses: {
            ...
            /** @description Unsupported RAW format */
            400: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Preview extraction failed */
            500: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    search_images_by_text_api_similarity_text_search_get: {
        parameters: {
            query: {
                ...
                /** @description Maximum number of results */
                limit?: number;
                /** @description Scope search to folder (ignored if folder_ids set) */
                folder_path?: string | null;
                /** @description Scope search to folder IDs (includes subfolders when expanded client-side) */
                folder_ids?: number[] | null;
                /** @description Minimum similarity threshold */
                min_similarity?: number | null;
                /** @description Minimum star rating */
                min_rating?: number | null;
                /** @description Filter by color label (Red, Yellow, Green, Blue, Purple) */
                color_label?: string | null;
                /** @description Also require normalized keyword match (AND filter) */
                keyword?: string | null;
                /** @description Filter by capture date (YYYY-MM-DD) */
                captured_date?: string | null;
                /** @description Secondary sort after relevance (capture_date, created_at, rating, score_general, ...) */
                sort_by?: string | null;
                /** @description Secondary sort direction (ASC or DESC) */
                order?: string | null;
            };
            header?: never;
            path?: never;
    ...
    preview_validation_repair_api_runs_plan_preview_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_run_folder_buckets_api_runs_folder_buckets_get: {
        parameters: {
            query?: {
                root_path?: string | null;
                q?: string | null;
    ...
    auto_drive_runs_api_runs_auto_drive_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["RunsAutoDriveRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    start_runs_drive_api_runs_drive_start_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["RunsDriveStartRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    stop_runs_drive_api_runs_drive_stop_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    runs_drive_status_api_runs_drive_status_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    raw_query_api_db_query_post: {
        parameters: {
            query?: never;
            header?: {
                "X-DB-Write-Token"?: string | null;
            };
            path?: never;
            cookie?: never;
        };
    ...
    raw_transaction_api_db_transaction_post: {
        parameters: {
            query?: never;
            header?: {
                "X-DB-Write-Token"?: string | null;
    ...
    get_image_details_api_db_images_by_path_get: {
        parameters: {
            query: {
                /** @description Full path to the image file */
                file_path: string;
    ...
    delete_image_api_db_images_by_path_delete: {
        parameters: {
            query: {
                /** @description Full path to the image file */
                file_path: string;
    ...
    get_image_by_hash_api_db_images_by_hash__image_hash__get: {
        parameters: {
            query?: {
                /** @description images.hash_version */
                hash_version?: number | null;
            };
            header?: never;
            path: {
    ...
    upsert_image_api_db_images_upsert_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_incomplete_records_api_db_images_incomplete_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    update_image_fields_api_db_images__image_id__patch: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    update_image_fields_batch_api_db_images_batch_update_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    update_embeddings_batch_api_db_images_batch_embeddings_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_all_paths_api_db_images__image_id__paths_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    get_resolved_path_api_db_images__image_id__resolved_path_get: {
        parameters: {
            query?: {
    ...
    get_image_phases_api_db_images__image_id__phases_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    get_job_api_db_jobs__job_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    update_job_status_api_db_jobs__job_id__patch: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    dequeue_job_api_db_jobs_dequeue_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    enqueue_job_api_db_jobs_enqueue_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    recover_interrupted_jobs_api_db_jobs_recover_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_job_phases_api_db_jobs__job_id__phases_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    create_job_phase_api_db_jobs__job_id__phases_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    update_job_phase_api_db_jobs__job_id__phases__phase_code__put: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    get_folders_api_db_folders_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    is_folder_scored_api_db_folders_scored_get: {
        parameters: {
            query: {
                folder_path: string;
            };
    ...
    get_or_create_folder_api_db_folders_get_or_create_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    sync_folders_api_db_folders_sync_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_folder_phase_summary_api_db_folders_phase_summary_get: {
        parameters: {
            query: {
                folder_path: string;
            };
    ...
    update_folder_phase_status_api_db_folders_phase_status_put: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_stacks_count_api_db_stacks_count_get: {
        parameters: {
            query?: {
                folder_id?: number | null;
            };
    ...
    get_stacks_by_image_ids_api_db_stacks_by_image_ids_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    create_stacks_batch_api_db_stacks_batch_create_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    clear_stacks_api_db_stacks_clear_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Body_clear_stacks_api_db_stacks_clear_post"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    create_culling_session_api_db_culling_sessions_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_culling_session_api_db_culling_sessions__session_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    generate_uuid_api_db_utils_generate_uuid_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    backup_database_api_db_backup_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    status_data_endpoint_api_status_data_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    status_logs_endpoint_api_status_logs_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    status_log_tails_endpoint_api_status_log_tails_get: {
        parameters: {
            query?: {
    ...
    manifest_endpoint_manifest_json_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
