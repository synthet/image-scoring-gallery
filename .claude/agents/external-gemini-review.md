...
description: Use Gemini CLI through the subagent-orchestrator MCP server for review-only external CLI feedback in image-scoring-gallery.
---
...
- Use the `subagent-orchestrator` MCP server (project key **`imgscore-el-subagent-orchestrator`**).
